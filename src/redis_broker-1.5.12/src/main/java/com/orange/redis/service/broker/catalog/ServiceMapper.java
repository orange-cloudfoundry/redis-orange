...
public class ServiceMapper {
  ...
  public static ServiceDefinition toServiceDefinition(Service service) {
    return new ServiceDefinition(service.getId().toString(), service.getName(), service.getDescription(),
        service.getBindable(), service.getPlanUpdateable(), PlanMapper.toServiceBrokerPlans(service.getPlans()),
        service.getTags(), service.getMetadata(), service.getRequires(), null);
  }
