...
public class PlanMapper {
  ...
  public static org.springframework.cloud.servicebroker.model.Plan toServiceBrokerPlan(Plan plan) {
    ...
    return new org.springframework.cloud.servicebroker.model.Plan(plan.getId(), plan.getName(), plan.getDescription(),
        plan.getMetadata(), plan.getFree());
  }

  public static List<org.springframework.cloud.servicebroker.model.Plan>
      toServiceBrokerPlans(List<Plan> planProperties) {
