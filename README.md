...
- [*redis_exporter*](https://github.com/oliver006/redis_exporter) [*0.32.0*](https://github.com/oliver006/redis_exporter/releases/download/v0.32.0/redis_exporter-v0.32.0.linux-amd64.tar.gz)
- [*OpenJDK*](https://openjdk.java.net/) [*12*](https://download.java.net/java/GA/jdk12/GPL/openjdk-12_linux-x64_bin.tar.gz)
